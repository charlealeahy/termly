...
2. **Test from a UK IP** in incognito — consent banner should appear, click Accept, ads should load
...
- [Google CSP guidance for AdSense](https://developers.google.com/tag-platform/security/guides/csp)
